...
**Core:**
- `pi-web-ui/src/tools/types.ts` - Interfaces
- `pi-web-ui/src/tools/renderer-registry.ts` - Registration
- `pi-web-ui/src/components/Messages.ts` - Rendering logic

**Renderers:**
- `pi-web-ui/src/tools/renderers/` - Built-in renderers
